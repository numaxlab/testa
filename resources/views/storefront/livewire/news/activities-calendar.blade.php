<article class="container mx-auto px-4">
    <header>
        ...
        <h1 class="at-heading is-1">
            ...
            <a
                    href="{{ route('testa.storefront.activities.index') }}"
                    wire:navigate
                    class="at-small"
            >
                {{ __('Ver lista') }}
    ...
    <div id="app">
        ...
        <div class="my-6 flex flex-wrap items-center justify-between space-y-4 sm:space-y-0 sm:space-x-4">
        ...
        <div id="calendarGridContainer" class="hidden sm:block overflow-hidden">
            <div class="grid grid-cols-7 text-center">
                <div class="bg-primary text-white py-2 font-semibold">Lun</div>
                ...
                <div class="bg-primary text-white py-2 font-semibold">Dom</div>
            </div>
        ...
        <div id="mobileViewContainer" class="sm:hidden mt-6 px-2">
            ...
            <div class="grid grid-cols-7 text-center overflow-hidden">
    ...
    <script>
        ...
        function populateSelectors () {
            ...
            monthSelector.innerHTML = months.map((month, index) =>
                `<option value="${index}" ${index === curre3ntMonth ? 'selected' : ''}>${month}</option>`,
            ).join('');
