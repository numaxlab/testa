...
use Testa\Storefront\Livewire\Components\Account\Addresses;
...
describe('Addresses component', function () {
    it('has addresses property defined as Collection type', function () {
        $component = new Addresses();

        expect(property_exists($component, 'addresses'))->toBeTrue();

        $reflection = new ReflectionClass($component);
        $property = $reflection->getProperty('addresses');
    ...
    it('returns correct view name', function () {
        $viewPath = 'testa::storefront.livewire.components.account.addresses';
