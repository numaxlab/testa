...
use Testa\Storefront\Livewire\Components\Bookshop\TaxonomySummary;
...
describe('TaxonomySummary component', function () {
    it('has collection property', function () {
        $component = new TaxonomySummary();

        expect(property_exists($component, 'collection'))->toBeTrue();
    });
    ...
    it('returns correct view name', function () {
        $viewPath = 'testa::storefront.livewire.components.bookshop.taxonomy-summary';
    ...
    it('limits products to 6', function () {
