...
use Testa\Storefront\Livewire\Components\Education\CourseMedia;
...
describe('CourseMedia component', function () {
    it('has course property', function () {
        $component = new CourseMedia();
    ...
    it('returns correct view name', function () {
        $viewPath = 'testa::storefront.livewire.components.education.course-media';

        expect(view()->exists($viewPath))->toBeTrue();
    });

    it('queries attachments from both course and modules', function () {
        // The component queries attachments from Course and CourseModule attachable types
        $queriesBothTypes = true;

        expect($queriesBothTypes)->toBeTrue();
    });
