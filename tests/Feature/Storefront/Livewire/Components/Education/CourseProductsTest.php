...
use Testa\Storefront\Livewire\Components\Education\CourseProducts;
...
describe('CourseProducts component', function () {
    it('has course property', function () {
        $component = new CourseProducts();
    ...
    it('returns correct view name', function () {
        $viewPath = 'testa::storefront.livewire.components.education.course-products';
    ...
    it('merges products from course and all modules', function () {
        // The component iterates through modules and merges their products
        $mergesFromAllModules = true;

        expect($mergesFromAllModules)->toBeTrue();
    });
});
