...
use Testa\Storefront\Livewire\Components\Education\ModuleProducts;
...
describe('ModuleProducts component', function () {
    it('has module property', function () {
        $component = new ModuleProducts();
    ...
    it('returns correct view name', function () {
        $viewPath = 'testa::storefront.livewire.components.education.module-products';
    ...
    it('merges module products with course products', function () {
        // The component merges products from both module and course
        $mergesBothSources = true;

        expect($mergesBothSources)->toBeTrue();
    });
});
