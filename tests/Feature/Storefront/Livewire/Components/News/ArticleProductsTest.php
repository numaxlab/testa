...
use Testa\Storefront\Livewire\Components\News\ArticleProducts;
...
describe('ArticleProducts component', function () {
    it('has article property', function () {
        $component = new ArticleProducts();

        expect(property_exists($component, 'article'))->toBeTrue();
    });
    ...
    it('returns correct view name', function () {
        $viewPath = 'testa::storefront.livewire.components.news.article-products';
