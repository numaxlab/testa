...
use Testa\Storefront\Livewire\Components\News\EventMedia;
...
describe('EventMedia component', function () {
    it('has event property', function () {
        $component = new EventMedia();
    ...
    it('returns correct view name', function () {
        $viewPath = 'testa::storefront.livewire.components.news.event-media';
