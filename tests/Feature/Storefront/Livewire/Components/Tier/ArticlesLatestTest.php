...
use Testa\Storefront\Livewire\Components\Tier\ArticlesLatest;
...
describe('ArticlesLatest component', function () {
    it('has tier property', function () {
        $component = new ArticlesLatest();

        expect(property_exists($component, 'tier'))->toBeTrue();
    });

    it('returns correct view name', function () {
        $viewPath = 'testa::storefront.livewire.components.tier.articles-latest';
