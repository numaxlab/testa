...
use Testa\Storefront\Livewire\Components\Tier\EducationTopics;
...
describe('EducationTopics component', function () {
    it('has tier property', function () {
        $component = new EducationTopics();

        expect(property_exists($component, 'tier'))->toBeTrue();
    });

    it('has topics property defined as Collection type', function () {
        $component = new EducationTopics();

        expect(property_exists($component, 'topics'))->toBeTrue();

        $reflection = new ReflectionClass($component);
        $property = $reflection->getProperty('topics');
    ...
    it('returns correct view name', function () {
        $viewPath = 'testa::storefront.livewire.components.tier.education-topics';
