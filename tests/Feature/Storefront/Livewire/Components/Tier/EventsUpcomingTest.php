...
use Testa\Storefront\Livewire\Components\Tier\EventsUpcoming;
...
describe('EventsUpcoming component', function () {
    it('has tier property', function () {
        $component = new EventsUpcoming();

        expect(property_exists($component, 'tier'))->toBeTrue();
    });

    it('returns correct view name', function () {
        $viewPath = 'testa::storefront.livewire.components.tier.events-upcoming';
